...
then
    ...
    then
        ...
        if [[ -e "/etc/apt/sources.list.d/parrot.list" ]]; then
            ...
            echo "deb https://deb.parrot.sh/parrot/ lory main contrib non-free non-free-firmware" | sudo tee -a /etc/apt/sources.list.d/parrot.list
            echo "deb https://deb.parrot.sh/parrot/ lory-security main contrib non-free non-free-firmware" | sudo tee -a /etc/apt/sources.list.d/parrot.list
    ...
    then
        ...
        if [[ -e "etc/yum.repos.d/parrot.repo" ]]; then
            ...
            echo "deb https://deb.parrot.sh/parrot/ lory main contrib non-free non-free-firmware" | sudo tee -a /etc/yum.repos.d/parrot.repo
            echo "deb https://deb.parrot.sh/parrot/ lory-security main contrib non-free non-free-firmware" | sudo tee -a /etc/yum.repos.d/parrot.repo
            echo "Parrot repos added successfully!"
